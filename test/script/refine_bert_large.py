...
save_dir = 'data/model/refine-bert-large'
parser.train(train_file=['data/semeval15/en.dm.train.conllu',
             ...
             bert_path=['data/embedding/en.train.large.uncased.bert', 'data/embedding/en.dev.large.uncased.bert'],
             root='root')
...
parser.evaluate(test_files=['data/semeval15/en.id.dm.conllu',
                ...
                bert_path='data/embedding/en.id.large.uncased.bert',
...
parser.evaluate(test_files=['data/semeval15/en.ood.dm.conllu',
                ...
                bert_path='data/embedding/en.ood.large.uncased.bert',
                save_dir=save_dir, logger=logger)
