...
save_dir = 'data/model/ptb-refine-joint-sdp'
...
parser.evaluate(test_files=['data/semeval15/en.id.dm.conllu',
                            ...
                            'data/ptb-sdp/ptb.sdp.test.conllu'], save_dir=save_dir, logger=logger)
