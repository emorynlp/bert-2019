...
save_dir = 'data/model/pas-psd-sharernn'
...
parser.dump(save_dir)
logger = init_logger(save_dir, 'test.log')
parser.evaluate(test_files=['data/semeval15/en.id.psd.conllu',
                            'data/semeval15/en.id.pas.conllu',
                            ], save_dir=save_dir, logger=logger)
parser.evaluate(test_files=['data/semeval15/en.ood.psd.conllu',
