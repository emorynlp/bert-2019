...
model_path = 'data/model/wsj-pos-bebu-ge2'
...
with mx.Context(mxnet_prefer_gpu()):
    embedding_types = [
        ...
        BERTEmbeddings(['data/embedding/base_sum/wsj.train.short.bert',
                        'data/embedding/base_sum/wsj.dev.bert',
                        'data/embedding/base_sum/wsj.test.bert']),
