...
for ratio in range(40, 101, 20):
    ...
    save_dir = 'data/model/transfer-dm-psd-pas-{}'.format(ratio)
    print(save_dir)
    parser.train(train_file=['data/semeval15/en.dm.train.{}.conllu'.format(ratio),
                 ...
                 lstm_hiddens=800, transfer='data/model/dm-psd-sharernn',
                 root='root')
    ...
    parser.evaluate(test_files=['data/semeval15/en.id.dm.conllu',
                                ...
                                'data/semeval15/en.id.pas.conllu'], save_dir=save_dir, logger=logger)
    parser.evaluate(test_files=['data/semeval15/en.ood.dm.conllu',
                                'data/semeval15/en.ood.psd.conllu',
                                'data/semeval15/en.ood.pas.conllu'], save_dir=save_dir, logger=logger)
