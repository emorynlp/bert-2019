...
model_path = 'data/model/conll032'
...
with mx.Context(mxnet_prefer_gpu()):
    embedding_types = [
        ...
        # BERTEmbeddings(['data/embedding/bert_base_sum/conll03.train.bert',
        #                 'data/embedding/bert_base_sum/conll03.dev.bert',
        #                 'data/embedding/bert_base_sum/conll03.test.bert']),
